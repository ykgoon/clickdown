...
The text-input-guards capability defines centralized state checking for text input fields and modal overlays. When text input is active, global keyboard shortcuts are routed to text input handlers instead of triggering their normal actions.
