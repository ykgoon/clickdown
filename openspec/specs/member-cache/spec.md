...
This capability defines the in-memory caching strategy for list members in the TUI application state, including cache lifetime, loading states, and lazy per-list caching behavior.
